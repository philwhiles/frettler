...
SET cmds[6]=frettler chord c,e,g=No instrument, just exact reverse chord lookup
SET cmds[7]=frettler chord c,e --rule relaxed=No instrument, just relaxed reverse chord lookup
SET cmds[8]=frettler chord c,e --rule loose=No instrument, just loose reverse chord lookup
SET cmds[9]=frettler guitar chord -n c,e,g =Standard guitar, lookup chord and display vertically
SET cmds[10]=frettler guitar vertical A scale_minor --chords=Standard guitar, vertical view of A Minor chord, with diatonic chords
SET cmds[11]=frettler guitar vertical C chord_maj=Standard guitar, vertical view of C Major arpeggio 
