...
SET cmds[14]=frettler guitar horizontal A scale_minor_pentatonic -s B,E,A,D,G,B,E=Am Pentatonic scale on a 7 string guitar
SET cmds[15]=frettler ukelele horizontal A scale_harmonic_minor=Ukelele, fretboard view of Am Harmonic scale 
SET cmds[16]=frettler guitar horizontal C scale_major --intervals=Standard guitar, fretboard view of C Major Scale with intervals
SET cmds[17]=frettler guitar horizontal A scale_minor -i=Again but with abbrev. intervals option, and an Am scale
SET cmds[18]=frettler guitar horizontal C chord_maj=Standard guitar, fretboard view of C Arpeggio
...
SET cmds[20]=frettler bassguitar horizontal C scale_major_pentatonic --intervals --frets 17=Bass guitar, fretboard view to 17th fret of C Major Pentatonic Scale, with intervals
SET cmds[21]=frettler banjo horizontal C scale_blues_major=Banjo, fretboard view of C Blues Major scale
SET cmds[22]=frettler guitar vertical G chord_maj=Guitar, vertical view of G Major arpeggio
