...
SET cmds[2]=frettler guitar horizontal C scale_major --octaves=Standard guitar, fretboard view of C Major scale, colourizing the fretboard relative octaves
SET cmds[3]=frettler guitar horizontal C scale_major --verbose=Standard guitar, fretboard view of C Major scale, verbose mode on
SET cmds[4]=frettler guitar horizontal C scale_major --chords --verbose=Standard guitar, fretboard view of C Major scale, derive diatonic chords, verbose mode on
SET cmds[5]=frettler chord c,e,g=No instrument, just exact reverse chord lookup
SET cmds[6]=frettler chord c,e --rule relaxed=No instrument, just relaxed reverse chord lookup
SET cmds[7]=frettler chord c,e --rule loose=No instrument, just loose reverse chord lookup
...
SET cmds[15]=frettler guitar horizontal C scale_major --intervals=Standard guitar, fretboard view of C Major Scale with intervals
SET cmds[16]=frettler guitar horizontal A scale_minor -i=Again but with abbrev. intervals option, and an Am scale
