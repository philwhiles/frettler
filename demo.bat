...
SET cmds[7]=frettler guitar chord a chord_min=Standard guitar, chord chart of Am
...
SET cmds[18]=frettler guitar vertical C chord_maj=Standard guitar, vertical view of C Major complete 
...
SET cmds[24]=frettler guitar horizontal C chord_maj=Standard guitar, fretboard view of C Major complete
...
SET cmds[34]=frettler guitar random=Display a random chord on a guitar
