...
import static me.flotsam.frettler.engine.IntervalPattern.CHORD_AUG7;
...
import static me.flotsam.frettler.engine.IntervalPattern.CHORD_DOM7;
...
import static me.flotsam.frettler.engine.IntervalPattern.CHORD_9;
...
import static me.flotsam.frettler.instrument.FrettedInstrument.InstrumentDefinition.BASSGUITAR_EADG;
import static me.flotsam.frettler.instrument.FrettedInstrument.InstrumentDefinition.MANDOLIN_GDAE;
...
public class ChordBank {
  ...
  private static Map<InstrumentDefinition, List<ChordDefinition>> definitions = Map.of(
      MANDOLIN_GDAE, Arrays.asList(
          new ChordDefinition(A, CHORD_MAJ, "2,2,4,5"),
          new ChordDefinition(A, CHORD_DOM7, "2,2,4,3"),
          new ChordDefinition(A, CHORD_MIN, "2,2,3,5"),
          new ChordDefinition(A, CHORD_MIN7, "2,2,3,3"),
          new ChordDefinition(A, CHORD_MAJ7, "2,2,4,4"),
          new ChordDefinition(A, CHORD_MAJ6, "2,2,4,2"),
          new ChordDefinition(A, CHORD_MIN6, "2,2,3,2"),
          new ChordDefinition(A, CHORD_9, "2,2,2,3"),
          new ChordDefinition(A, CHORD_DIM7, "2,1,3,2"),
          new ChordDefinition(A, CHORD_AUG, "2,3,4,5"),
          new ChordDefinition(A, CHORD_SUS4, "2,2,5,5"),

          new ChordDefinition(Bb, CHORD_MAJ, "3,3,5,6"),
          new ChordDefinition(Bb, CHORD_DOM7, "3,3,5,4"),
          new ChordDefinition(Bb, CHORD_MIN, "3,3,4,6"),
          new ChordDefinition(Bb, CHORD_MIN7, "3,3,4,4"),
          new ChordDefinition(Bb, CHORD_MAJ7, "3,3,5,5"),
          new ChordDefinition(Bb, CHORD_MAJ6, "3,3,5,3"),
          new ChordDefinition(Bb, CHORD_MIN6, "3,3,4,3"),
          new ChordDefinition(Bb, CHORD_9, "3,3,3,4"),
          new ChordDefinition(Bb, CHORD_DIM7, "3,2,4,3"),
          new ChordDefinition(Bb, CHORD_AUG, "3,4,5,6"),
          new ChordDefinition(Bb, CHORD_SUS4, "3,3,6,6"),

          new ChordDefinition(B, CHORD_MAJ, "4,4,6,7"),
          new ChordDefinition(B, CHORD_DOM7, "4,4,6,5"),
          new ChordDefinition(B, CHORD_MIN, "4,4,5,7"),
          new ChordDefinition(B, CHORD_MIN7, "4,4,5,5"),
          new ChordDefinition(B, CHORD_MAJ7, "4,4,6,6"),
          new ChordDefinition(B, CHORD_MAJ6, "4,4,6,4"),
          new ChordDefinition(B, CHORD_MIN6, "4,4,5,4"),
          new ChordDefinition(B, CHORD_9, "4,4,4,5"),
          new ChordDefinition(B, CHORD_DIM7, "4,3,5,4"),
          new ChordDefinition(B, CHORD_AUG, "4,5,6,7"),

          new ChordDefinition(C, CHORD_MAJ, "0,2,3,3"),
          new ChordDefinition(C, CHORD_DOM7, "0,2,1,3"),
          new ChordDefinition(C, CHORD_MIN, "0,1,3,3"),
          new ChordDefinition(C, CHORD_MIN7, "3,1,3,3"),
          new ChordDefinition(C, CHORD_MAJ7, "0,2,2,3"),
          new ChordDefinition(C, CHORD_MAJ6, "2,2,3,3"),
          new ChordDefinition(C, CHORD_MIN6, "2,1,3,3"),
          new ChordDefinition(C, CHORD_9, "3,0,3,0"),
          new ChordDefinition(C, CHORD_DIM7, "2,1,3,2"),
          new ChordDefinition(C, CHORD_AUG, "1,2,3,4"),
          new ChordDefinition(C, CHORD_SUS4, "0,3,3,3"),

          new ChordDefinition(Db, CHORD_MAJ, "1,3,4,4"),
          new ChordDefinition(Db, CHORD_DOM7, "1,3,2,4"),
          new ChordDefinition(Db, CHORD_MIN, "1,2,4,4"),
          new ChordDefinition(Db, CHORD_MIN7, "1,2,2,4"),
          new ChordDefinition(Db, CHORD_MAJ7, "1,3,3,4"),
          new ChordDefinition(Db, CHORD_MAJ6, "3,3,4,4"),
          new ChordDefinition(Db, CHORD_MIN6, "6,6,7,6"),
          new ChordDefinition(Db, CHORD_9, "4,3,6,4"),
          new ChordDefinition(Db, CHORD_DIM7, "3,2,4,3"),
          new ChordDefinition(Db, CHORD_AUG, "2,3,4,5"),

          new ChordDefinition(D, CHORD_MAJ, "2,0,0,2"),
          new ChordDefinition(D, CHORD_DOM7, "2,0,3,2"),
          new ChordDefinition(D, CHORD_MIN, "2,0,0,1"),
          new ChordDefinition(D, CHORD_MIN7, "2,0,3,1"),
          new ChordDefinition(D, CHORD_MAJ7, "2,0,4,2"),
          new ChordDefinition(D, CHORD_MAJ6, "2,0,2,2"),
          new ChordDefinition(D, CHORD_MIN6, "2,0,2,1"),
          new ChordDefinition(D, CHORD_9, "2,4,3,0"),
          new ChordDefinition(D, CHORD_DIM7, "1,0,2,1"),
          new ChordDefinition(D, CHORD_AUG, "3,4,5,6"),

          new ChordDefinition(Eb, CHORD_MAJ, "0,1,1,3"),
          new ChordDefinition(Eb, CHORD_DOM7, "3,1,4,3"),
          new ChordDefinition(Eb, CHORD_MIN, "3,4,6,6"),
          new ChordDefinition(Eb, CHORD_MIN7, "3,1,4,2"),
          new ChordDefinition(Eb, CHORD_MAJ7, "3,5,1,3"),
          new ChordDefinition(Eb, CHORD_MAJ6, "3,1,3,3"),
          new ChordDefinition(Eb, CHORD_MIN6, "3,1,3,2"),
          new ChordDefinition(Eb, CHORD_9, "3,3,4,3"),
          new ChordDefinition(Eb, CHORD_DIM7, "2,1,3,2"),
          new ChordDefinition(Eb, CHORD_AUG, "0,1,2,3"),

          new ChordDefinition(E, CHORD_MAJ, "4,6,2,0"),
          new ChordDefinition(E, CHORD_DOM7, "4,6,5,0"),
          new ChordDefinition(E, CHORD_MIN, "4,5,2,0"),
          new ChordDefinition(E, CHORD_MIN7, "0,0,2,0"),
          new ChordDefinition(E, CHORD_MAJ7, "1,1,2,4"),
          new ChordDefinition(E, CHORD_MAJ6, "4,2,4,4"),
          new ChordDefinition(E, CHORD_MIN6, "4,2,4,3"),
          new ChordDefinition(E, CHORD_9, "1,0,2,2"),
          new ChordDefinition(E, CHORD_DIM7, "3,2,4,3"),
          new ChordDefinition(E, CHORD_AUG, "1,2,3,4"),
          new ChordDefinition(E, CHORD_SUS4, "2,2,2,0"),

          new ChordDefinition(F, CHORD_MAJ, "2,3,0,1"),
          new ChordDefinition(F, CHORD_DOM7, "2,1,3,1"),
          new ChordDefinition(F, CHORD_MIN, "1,3,3,4"),
          new ChordDefinition(F, CHORD_MIN7, "1,1,3,1"),
          new ChordDefinition(F, CHORD_MAJ7, "2,3,3,0"),
          new ChordDefinition(F, CHORD_MAJ6, "2,0,3,1"),
          new ChordDefinition(F, CHORD_MIN6, "1,0,3,1"),
          new ChordDefinition(F, CHORD_9, "2,1,3,3"),
          new ChordDefinition(F, CHORD_DIM7, "1,0,2,1"),
          new ChordDefinition(F, CHORD_AUG, "2,3,4,5"),
          new ChordDefinition(F, CHORD_SUS2, "x,3,3,3"),
          new ChordDefinition(F, CHORD_SUS4, "3,3,3,6"),

          new ChordDefinition(Gb, CHORD_MAJ, "3,4,4,6"),
          new ChordDefinition(Gb, CHORD_DOM7, "3,4,4,0"),
          new ChordDefinition(Gb, CHORD_MIN, "2,4,4,5"),
          new ChordDefinition(Gb, CHORD_MIN7, "2,4,4,0"),
          new ChordDefinition(Gb, CHORD_MAJ7, "3,4,4,1"),
          new ChordDefinition(Gb, CHORD_MAJ6, "3,1,4,2"),
          new ChordDefinition(Gb, CHORD_MIN6, "2,1,4,2"),
          new ChordDefinition(Gb, CHORD_9, "3,2,4,4"),
          new ChordDefinition(Gb, CHORD_DIM7, "2,1,3,2"),
          new ChordDefinition(Gb, CHORD_AUG, "3,4,5,6"),
          new ChordDefinition(Gb, CHORD_SUS2, "1,4,4,4"),

          new ChordDefinition(G, CHORD_MAJ, "0,0,2,3"),
          new ChordDefinition(G, CHORD_DOM7, "0,0,2,1"),
          new ChordDefinition(G, CHORD_MIN, "0,0,1,3"),
          new ChordDefinition(G, CHORD_MIN7, "0,0,1,1"),
          new ChordDefinition(G, CHORD_MAJ7, "0,0,2,2"),
          new ChordDefinition(G, CHORD_MAJ6, "0,0,2,0"),
          new ChordDefinition(G, CHORD_MIN6, "0,0,1,0"),
          new ChordDefinition(G, CHORD_9, "0,0,0,1"),
          new ChordDefinition(G, CHORD_DIM7, "3,2,4,3"),
          new ChordDefinition(G, CHORD_AUG, "0,1,2,3"),
          new ChordDefinition(G, CHORD_SUS4, "0,0,3,3"),

          new ChordDefinition(Ab, CHORD_MAJ, "1,1,3,4"),
          new ChordDefinition(Ab, CHORD_DOM7, "1,1,3,2"),
          new ChordDefinition(Ab, CHORD_MIN, "1,1,2,4"),
          new ChordDefinition(Ab, CHORD_MIN7, "1,1,2,2"),
          new ChordDefinition(Ab, CHORD_MAJ7, "1,1,3,3"),
          new ChordDefinition(Ab, CHORD_MAJ6, "1,1,3,1"),
          new ChordDefinition(Ab, CHORD_MIN6, "1,1,2,1"),
          new ChordDefinition(Ab, CHORD_9, "1,1,1,2"),
          new ChordDefinition(Ab, CHORD_DIM7, "1,0,2,1"),
          new ChordDefinition(Ab, CHORD_AUG, "1,2,3,4"),
          new ChordDefinition(Ab, CHORD_SUS4, "6,6,6,9")
      ),
      BASSGUITAR_EADG, Arrays.asList(
        new ChordDefinition(C, CHORD_MAJ, "x,3,2,0"),
        new ChordDefinition(C, CHORD_MIN, "x,3,1,0"),
        new ChordDefinition(C, CHORD_AUG, "x,3,2,1"),
        new ChordDefinition(C, CHORD_DIM, "2,3,1,x"),
        new ChordDefinition(C, CHORD_MAJ6, "x,3,2,2"),
        new ChordDefinition(C, CHORD_DOM7, "x,3,2,3"),
        new ChordDefinition(C, CHORD_MAJ7, "x,3,2,4"),
        new ChordDefinition(C, CHORD_MIN7, "x,3,1,3"),
  
        new ChordDefinition(F, CHORD_MAJ, "x,3,3,2"),
        new ChordDefinition(F, CHORD_MIN, "x,3,3,1"),
        new ChordDefinition(F, CHORD_AUG, "x,4,3,2"),
        new ChordDefinition(F, CHORD_DIM, "x,2,3,1"),
        new ChordDefinition(F, CHORD_MAJ6, "1,0,0,x"),
        new ChordDefinition(F, CHORD_DOM7, "1,0,1,x"),
        new ChordDefinition(F, CHORD_MAJ7, "1,3,2,x"),
        new ChordDefinition(F, CHORD_MIN7, "1,3,1,x"),
  
        new ChordDefinition(Bb, CHORD_MAJ, "1,1,0,x"),
        new ChordDefinition(Bb, CHORD_MIN, "x,4,3,3"),
        new ChordDefinition(Bb, CHORD_AUG, "2,1,0,x"),
        new ChordDefinition(Bb, CHORD_DIM, "x,4,2,3"),
        new ChordDefinition(Bb, CHORD_MAJ6, "x,1,0,0"),
        new ChordDefinition(Bb, CHORD_DOM7, "x,1,0,1"),
        new ChordDefinition(Bb, CHORD_MAJ7, "x,1,3,2"),
        new ChordDefinition(Bb, CHORD_MIN7, "x,1,3,1"),
  
        new ChordDefinition(Eb, CHORD_MAJ, "3,1,1,x"),
        new ChordDefinition(Eb, CHORD_MIN, "2,1,1,x"),
        new ChordDefinition(Eb, CHORD_AUG, "3,2,1,x"),
        new ChordDefinition(Eb, CHORD_DIM, "2,0,1,x"),
        new ChordDefinition(Eb, CHORD_MAJ6,"3,3,1,x"),
        new ChordDefinition(Eb, CHORD_DOM7, "3,4,1,x"),
        new ChordDefinition(Eb, CHORD_MAJ7, "x,6,5,7"),
        new ChordDefinition(Eb, CHORD_MIN7, "x,6,4,6"),
        
        new ChordDefinition(Ab, CHORD_MAJ, "4,3,1,x"),
        new ChordDefinition(Ab, CHORD_MIN, "4,2,1,x"),
        new ChordDefinition(Ab, CHORD_AUG, "4,3,2,x"),
        new ChordDefinition(Ab, CHORD_DIM, "4,2,0,x"),
        new ChordDefinition(Ab, CHORD_MAJ6, "4,3,3,x"),
        new ChordDefinition(Ab, CHORD_DOM7, "4,3,4,x"),
        new ChordDefinition(Ab, CHORD_MAJ7, "4,3,5,x"),
        new ChordDefinition(Ab, CHORD_MIN7, "4,2,4,x"),
  
        new ChordDefinition(Db, CHORD_MAJ, "x,4,3,1"),
        new ChordDefinition(Db, CHORD_MIN, "x,4,2,1"),
        new ChordDefinition(Db, CHORD_AUG, "x,4,3,2"),
        new ChordDefinition(Db, CHORD_DIM, "x,4,2,0"),
        new ChordDefinition(Db, CHORD_MAJ6,"x,4,3,3"),
        new ChordDefinition(Db, CHORD_DOM7, "x,4,3,4"),
        new ChordDefinition(Db, CHORD_MAJ7, "x,4,3,5"),
        new ChordDefinition(Db, CHORD_MIN7, "x,4,2,4"),
  
        new ChordDefinition(Gb, CHORD_MAJ, "x,4,4,3"),
        new ChordDefinition(Gb, CHORD_MIN, "x,4,4,2"),
        new ChordDefinition(Gb, CHORD_AUG, "x,5,4,3"),
        new ChordDefinition(Gb, CHORD_DIM, "x,3,4,2"),
        new ChordDefinition(Gb, CHORD_MAJ6, "2,1,1,x"),
        new ChordDefinition(Gb, CHORD_DOM7, "2,1,2,x"),
        new ChordDefinition(Gb, CHORD_MAJ7, "2,1,3,x"),
        new ChordDefinition(Gb, CHORD_MIN7, "2,4,2,x"),
  
        new ChordDefinition(B, CHORD_MAJ, "2,2,1,x"),
        new ChordDefinition(B, CHORD_MIN, "2,2,0,x"),
        new ChordDefinition(B, CHORD_AUG, "x,2,1,0"),
        new ChordDefinition(B, CHORD_DIM, "1,2,0,x"),
        new ChordDefinition(B, CHORD_MAJ6, "x,2,1,1"),
        new ChordDefinition(B, CHORD_DOM7, "x,2,1,2"),
        new ChordDefinition(B, CHORD_MAJ7, "x,2,1,3"),
        new ChordDefinition(B, CHORD_MIN7, "x,2,0,2"),
  
        new ChordDefinition(E, CHORD_MAJ, "x,2,2,1"),
        new ChordDefinition(E, CHORD_MIN, "x,2,2,0"),
        new ChordDefinition(E, CHORD_AUG, "x,3,2,1"),
        new ChordDefinition(E, CHORD_DIM, "x,1,2,0"),
        new ChordDefinition(E, CHORD_MAJ6, "x,4,2,1"),
        new ChordDefinition(E, CHORD_DOM7, "0,2,0,1"),
        new ChordDefinition(E, CHORD_MAJ7, "0,2,1,1"),
        new ChordDefinition(E, CHORD_MIN7, "0,2,0,0"),
  
        new ChordDefinition(A, CHORD_MAJ, "5,4,2,x"),
        new ChordDefinition(A, CHORD_MIN, "5,3,2,x"),
        new ChordDefinition(A, CHORD_AUG, "5,4,3,x"),
        new ChordDefinition(A, CHORD_DIM, "x,3,1,2"),
        new ChordDefinition(A, CHORD_MAJ6, "5,4,4,x"),
        new ChordDefinition(A, CHORD_DOM7, "5,4,5,x"),
        new ChordDefinition(A, CHORD_MAJ7, "5,4,6,x"),
        new ChordDefinition(A, CHORD_MIN7, "5,3,5,x"),
  
        new ChordDefinition(D, CHORD_MAJ, "x,5,4,2"),
        new ChordDefinition(D, CHORD_MIN, "x,5,3,2"),
        new ChordDefinition(D, CHORD_AUG, "x,5,4,3"),
        new ChordDefinition(D, CHORD_DIM, "x,5,3,1"),
        new ChordDefinition(D, CHORD_MAJ6, "x,5,4,4"),
        new ChordDefinition(D, CHORD_DOM7, "x,5,4,5"),
        new ChordDefinition(D, CHORD_MAJ7, "x,5,4,6"),
        new ChordDefinition(D, CHORD_MIN7, "x,5,3,5"),
  
        new ChordDefinition(G, CHORD_MAJ, "3,2,0,x"),
        new ChordDefinition(G, CHORD_MIN, "3,1,0,x"),
        new ChordDefinition(G, CHORD_AUG, "3,2,1,x"),
        new ChordDefinition(G, CHORD_DIM, "x,4,5,3"),
        new ChordDefinition(G, CHORD_MAJ6, "3,2,2,x"),
        new ChordDefinition(G, CHORD_DOM7, "3,2,3,x"),
        new ChordDefinition(G, CHORD_MAJ7, "3,2,4,x"),
        new ChordDefinition(G, CHORD_MIN7, "3,1,3,x")

      ),
      UKELELE_GCEA, Arrays.asList(
        new ChordDefinition(A, CHORD_MAJ, "2,1,0,0"),
        new ChordDefinition(A, CHORD_MIN, "2,0,0,0"),
        new ChordDefinition(A, CHORD_AUG, "2,1,1,4"),
        new ChordDefinition(A, CHORD_DIM, "2,3,5,3"),
        new ChordDefinition(A, CHORD_DOM7, "0,1,0,0"),
        new ChordDefinition(A, CHORD_MIN7, "0,0,0,0"),
        new ChordDefinition(A, CHORD_MAJ7, "1,1,0,0"),
        new ChordDefinition(A, CHORD_MAJ6, "2,1,2,0"),
        new ChordDefinition(A, CHORD_MIN6, "2,0,2,0"),
        new ChordDefinition(A, CHORD_ADD9, "2,1,0,2"),
        new ChordDefinition(A, CHORD_MIN9, "2,0,0,2"),
        new ChordDefinition(A, CHORD_DOM9, "0,1,0,2"),
        new ChordDefinition(A, CHORD_SUS2, "2,4,5,2"),
        new ChordDefinition(A, CHORD_SUS4, "2,2,0,0"),
        new ChordDefinition(A, CHORD_MIN7SUS4, "0,2,0,0"),

        new ChordDefinition(Bb, CHORD_MAJ, "3,2,1,1"),
        new ChordDefinition(Bb, CHORD_MIN, "3,1,1,1"),
        new ChordDefinition(Bb, CHORD_AUG, "3,2,2,1"),
        new ChordDefinition(Bb, CHORD_DIM, "3,1,0,1"),
        new ChordDefinition(Bb, CHORD_DOM7, "1,2,1,1"),
        new ChordDefinition(Bb, CHORD_MIN7, "1,1,1,1"),
        new ChordDefinition(Bb, CHORD_MAJ7, "3,2,1,0"),
        new ChordDefinition(Bb, CHORD_MAJ6, "0,2,1,1"),
        new ChordDefinition(Bb, CHORD_MIN6, "3,1,3,1"),
        new ChordDefinition(Bb, CHORD_ADD9, "3,2,1,3"),
        new ChordDefinition(Bb, CHORD_MIN9, "3,1,1,3"),
        new ChordDefinition(Bb, CHORD_DOM9, "3,2,4,3"),
        new ChordDefinition(Bb, CHORD_SUS2, "3,0,1,1"),
        new ChordDefinition(Bb, CHORD_SUS4, "3,3,1,1"),
        new ChordDefinition(Bb, CHORD_MIN7SUS4, "1,3,1,1"),
        
        new ChordDefinition(B, CHORD_MAJ, "4,3,2,2"),
        new ChordDefinition(B, CHORD_MIN, "4,2,2,2"),
        new ChordDefinition(B, CHORD_AUG, "4,3,3,2"),
        new ChordDefinition(B, CHORD_DIM, "4,2,1,2"),
        new ChordDefinition(B, CHORD_DOM7, "2,3,2,2"),
        new ChordDefinition(B, CHORD_MIN7, "2,2,2,2"),
        new ChordDefinition(B, CHORD_MAJ7, "4,3,2,1"),
        new ChordDefinition(B, CHORD_MAJ6, "1,3,2,2"),
        new ChordDefinition(B, CHORD_MIN6, "1,2,2,2"),
        new ChordDefinition(B, CHORD_ADD9, "4,3,2,4"),
        new ChordDefinition(B, CHORD_MIN9, "4,2,5,4"),
        new ChordDefinition(B, CHORD_DOM9, "4,3,5,4"),
        new ChordDefinition(B, CHORD_SUS2, "4,1,2,2"),
        new ChordDefinition(B, CHORD_SUS4, "4,4,2,2"),
        new ChordDefinition(B, CHORD_MIN7SUS4, "2,4,2,2"),

        
        new ChordDefinition(C, CHORD_MAJ, "0,0,0,3"),
        new ChordDefinition(C, CHORD_MIN, "0,3,3,3"),
        new ChordDefinition(C, CHORD_AUG, "1,0,0,3"),
        new ChordDefinition(C, CHORD_DIM, "x,3,2,3"),
        new ChordDefinition(C, CHORD_DOM7, "0,0,0,1"),
        new ChordDefinition(C, CHORD_MIN7, "3,3,3,3"),
        new ChordDefinition(C, CHORD_MAJ7, "0,0,0,2"),
        new ChordDefinition(C, CHORD_MAJ6, "0,0,0,0"),
        new ChordDefinition(C, CHORD_MIN6, "2,3,3,3"),
        new ChordDefinition(C, CHORD_ADD9, "0,4,3,3"),
        new ChordDefinition(C, CHORD_MIN9, "5,3,3,5"),
        new ChordDefinition(C, CHORD_DOM9, "0,2,0,1"),
        new ChordDefinition(C, CHORD_SUS2, "0,2,3,3"),
        new ChordDefinition(C, CHORD_SUS4, "0,0,1,3"),
        new ChordDefinition(C, CHORD_MIN7SUS4, "0,0,1,1"),

        
        new ChordDefinition(Db, CHORD_MAJ, "1,1,1,4"),
        new ChordDefinition(Db, CHORD_MIN, "1,4,4,4"),
        new ChordDefinition(Db, CHORD_AUG, "2,1,1,0"),
        new ChordDefinition(Db, CHORD_DIM, "0,1,0,4"),
        new ChordDefinition(Db, CHORD_DOM7, "1,1,1,2"),
        new ChordDefinition(Db, CHORD_MIN7, "1,1,0,2"),
        new ChordDefinition(Db, CHORD_MAJ7, "1,1,1,3"),
        new ChordDefinition(Db, CHORD_MAJ6, "1,1,1,1"),
        new ChordDefinition(Db, CHORD_MIN6, "1,1,0,1"),
        new ChordDefinition(Db, CHORD_ADD9, "1,3,1,4"),
        new ChordDefinition(Db, CHORD_MIN9, "1,3,0,4"),
        new ChordDefinition(Db, CHORD_DOM9, "1,3,1,2"),
        new ChordDefinition(Db, CHORD_SUS2, "1,3,4,4"),
        new ChordDefinition(Db, CHORD_SUS4, "1,1,2,4"),
        new ChordDefinition(Db, CHORD_MIN7SUS4, "1,1,2,2"),

        
        new ChordDefinition(D, CHORD_MAJ, "2,2,2,0"),
        new ChordDefinition(D, CHORD_MIN, "2,2,1,0"),
        new ChordDefinition(D, CHORD_AUG, "3,2,2,1"),
        new ChordDefinition(D, CHORD_DIM, "1,2,1,x"),
        new ChordDefinition(D, CHORD_DOM7, "2,2,2,3"),
        new ChordDefinition(D, CHORD_MIN7, "2,2,1,3"),
        new ChordDefinition(D, CHORD_MAJ7, "2,2,2,4"),
        new ChordDefinition(D, CHORD_MAJ6, "2,2,2,2"),
        new ChordDefinition(D, CHORD_MIN6, "2,2,1,2"),
        new ChordDefinition(D, CHORD_ADD9, "2,4,2,5"),
        new ChordDefinition(D, CHORD_MIN9, "2,5,0,5"),
        new ChordDefinition(D, CHORD_DOM9, "2,4,2,3"),
        new ChordDefinition(D, CHORD_SUS2, "2,2,0,0"),
        new ChordDefinition(D, CHORD_SUS4, "0,2,3,0"),
        new ChordDefinition(D, CHORD_MIN7SUS4, "2,2,3,3"),

        
        new ChordDefinition(Eb, CHORD_MAJ, "0,3,3,1"),
        new ChordDefinition(Eb, CHORD_MIN, "3,3,2,1"),
        new ChordDefinition(Eb, CHORD_AUG, "0,3,3,2"),
        new ChordDefinition(Eb, CHORD_DIM, "2,3,2,0"),
        new ChordDefinition(Eb, CHORD_DOM7, "3,3,3,4"),
        new ChordDefinition(Eb, CHORD_MIN7, "3,3,2,4"),
        new ChordDefinition(Eb, CHORD_MAJ7, "3,3,3,5"),
        new ChordDefinition(Eb, CHORD_MAJ6, "3,3,3,3"),
        new ChordDefinition(Eb, CHORD_MIN6, "3,3,2,3"),
        new ChordDefinition(Eb, CHORD_ADD9, "0,3,1,1"),
        new ChordDefinition(Eb, CHORD_MIN9, "6,5,2,6"),
        new ChordDefinition(Eb, CHORD_DOM9, "0,1,1,1"),
        new ChordDefinition(Eb, CHORD_SUS2, "3,3,1,1"),
        new ChordDefinition(Eb, CHORD_SUS4, "1,3,4,1"),
        new ChordDefinition(Eb, CHORD_MIN7SUS4, "3,3,4,4"),

        
        new ChordDefinition(E, CHORD_MAJ, "1,4,0,2"),
        new ChordDefinition(E, CHORD_MIN, "0,4,3,2"),
        new ChordDefinition(E, CHORD_AUG, "1,0,0,3"),
        new ChordDefinition(E, CHORD_DIM, "0,4,0,1"),
        new ChordDefinition(E, CHORD_DOM7, "1,2,0,2"),
        new ChordDefinition(E, CHORD_MIN7, "0,2,0,2"),
        new ChordDefinition(E, CHORD_MAJ7, "1,3,0,2"),
        new ChordDefinition(E, CHORD_MAJ6, "4,4,4,4"),
        new ChordDefinition(E, CHORD_MIN6, "0,1,0,2"),
        new ChordDefinition(E, CHORD_ADD9, "1,4,2,2"),
        new ChordDefinition(E, CHORD_MIN9, "0,4,2,2"),
        new ChordDefinition(E, CHORD_DOM9, "1,2,2,2"),
        new ChordDefinition(E, CHORD_SUS2, "4,4,2,2"),
        new ChordDefinition(E, CHORD_SUS4, "2,4,5,2"),
        new ChordDefinition(E, CHORD_MIN7SUS4, "4,4,5,5"),

        
        new ChordDefinition(F, CHORD_MAJ, "2,0,1,0"),
        new ChordDefinition(F, CHORD_MIN, "1,0,1,3"),
        new ChordDefinition(F, CHORD_AUG, "2,1,1,0"),
        new ChordDefinition(F, CHORD_DIM, "1,x,1,2"),
        new ChordDefinition(F, CHORD_DOM7, "2,3,1,3"),
        new ChordDefinition(F, CHORD_MIN7, "1,3,1,3"),
        new ChordDefinition(F, CHORD_MAJ7, "2,4,1,3"),
        new ChordDefinition(F, CHORD_MAJ6, "2,2,1,3"),
        new ChordDefinition(F, CHORD_MIN6, "1,2,1,3"),
        new ChordDefinition(F, CHORD_ADD9, "0,0,1,0"),
        new ChordDefinition(F, CHORD_MIN9, "0,5,4,3"),
        new ChordDefinition(F, CHORD_DOM9, "2,3,3,3"),
        new ChordDefinition(F, CHORD_SUS2, "0,0,1,3"),
        new ChordDefinition(F, CHORD_SUS4, "3,0,1,1"),
        new ChordDefinition(F, CHORD_MIN7SUS4, "5,5,6,6"),

        
        new ChordDefinition(Gb, CHORD_MAJ, "3,1,2,1"),
        new ChordDefinition(Gb, CHORD_MIN, "2,1,2,0"),
        new ChordDefinition(Gb, CHORD_AUG, "3,2,2,1"),
        new ChordDefinition(Gb, CHORD_DIM, "2,0,2,0"),
        new ChordDefinition(Gb, CHORD_DOM7, "3,4,2,4"),
        new ChordDefinition(Gb, CHORD_MIN7, "2,4,2,4"),
        new ChordDefinition(Gb, CHORD_MAJ7, "3,5,2,4"),
        new ChordDefinition(Gb, CHORD_MAJ6, "3,3,2,4"),
        new ChordDefinition(Gb, CHORD_MIN6, "2,3,2,4"),
        new ChordDefinition(Gb, CHORD_ADD9, "1,1,2,1"),
        new ChordDefinition(Gb, CHORD_MIN9, "1,4,2,0"),
        new ChordDefinition(Gb, CHORD_DOM9, "1,1,0,1"),
        new ChordDefinition(Gb, CHORD_SUS2, "1,1,2,4"),
        new ChordDefinition(Gb, CHORD_SUS4, "4,1,2,2"),
        new ChordDefinition(Gb, CHORD_MIN7SUS4, "6,6,7,7"),

        
        new ChordDefinition(G, CHORD_MAJ, "0,2,3,2"),
        new ChordDefinition(G, CHORD_MIN, "0,2,3,1"),
        new ChordDefinition(G, CHORD_AUG, "0,3,3,2"),
        new ChordDefinition(G, CHORD_DIM, "0,1,3,1"),
        new ChordDefinition(G, CHORD_DOM7, "0,2,1,2"),
        new ChordDefinition(G, CHORD_MIN7, "0,2,1,1"),
        new ChordDefinition(G, CHORD_MAJ7, "0,2,2,2"),
        new ChordDefinition(G, CHORD_MAJ6, "0,2,0,2"),
        new ChordDefinition(G, CHORD_MIN6, "0,2,0,1"),
        new ChordDefinition(G, CHORD_ADD9, "0,2,5,2"),
        new ChordDefinition(G, CHORD_MIN9, "2,2,3,1"),
        new ChordDefinition(G, CHORD_DOM9, "2,2,1,2"),
        new ChordDefinition(G, CHORD_SUS2, "0,2,3,0"),
        new ChordDefinition(G, CHORD_SUS4, "0,2,3,3"),
        new ChordDefinition(G, CHORD_MIN7SUS4, "0,2,1,3")
      ),
      GUITAR_EADGBE, Arrays.asList(
        ...
        new ChordDefinition(A, CHORD_AUG7, "x,0,3,0,2,1", new String[] {"x,x,3,x,2,1"}),
        ...
        new ChordDefinition(A, CHORD_DOM7, "x,0,2,0,2,0", new String[] {"x,x,1,x,2,x", "x,x,2,x,3,x"}),
        new ChordDefinition(A, CHORD_DOM7, "x,0,2,2,2,3", new String[] {"x,x,1,1,1,2", "x,x,1,2,3,4"}),
        new ChordDefinition(A, CHORD_DOM7, "3,x,2,2,2,0"), // (Db E  G  A) : major triad, minor 7th
        
        new ChordDefinition(A, CHORD_DOM9, "x,0,2,4,2,3"), 
        ...
        new ChordDefinition(A, CHORD_MAJ, "x,12,11,9,10,9"), // (Db E  A) : major triad
        ...
        new ChordDefinition(Ab, CHORD_AUG7, "0,3,2,1,1,2", new String[] {"x,4,2,1,1,3"}),
        new ChordDefinition(Ab, CHORD_AUG7, "4,x,4,5,5,x", new String[] {"1,x,2,3,4,x"}),
        ...
        new ChordDefinition(Ab, CHORD_DOM7, "x,x,1,1,1,2", new String[] {"x,x,1,1,1,2", "x,x,1,1,1,2"}),
        new ChordDefinition(Ab, CHORD_DOM7, "x,x,4,5,4,4"), // (C  Eb Gb Ab) : major triad, minor 7th
        
//        new ChordDefinition(Ab, CHORD_MAJ, "1,3,3,2,1,1"), 
        ...
        new ChordDefinition(Ab, CHORD_MAJ6, "4,3,1,1,1,1"), 
        new ChordDefinition(Ab, CHORD_MAJ6, "x,8,10,8,9,8"), // (C  Eb F  Ab) : major triad plus 6th

//        new ChordDefinition(Ab, CHORD_MAJ9, "x,x,1,3,1,2"), 
        ...
        new ChordDefinition(B, CHORD_AUG7, "x,2,1,2,0,3", new String[] {"x,2,1,3,x,4"}),
        new ChordDefinition(B, CHORD_AUG7, "x,2,5,2,4,x", new String[] {"x,1,4,1,3,x"}),
        ...
        new ChordDefinition(B, CHORD_DOM7, "x,0,1,2,0,2"), // (Eb Gb A  B) : major triad, minor 7th
        new ChordDefinition(B, CHORD_DOM7, "2,x,1,2,0,2"), // (Eb Gb A  B) : major triad, minor 7th
        new ChordDefinition(B, CHORD_DOM7, "x,2,1,2,0,2", new String[] {"x,2,1,3,x,4", "x,2,1,3,x,4"}),
        new ChordDefinition(B, CHORD_DOM7, "x,2,4,2,4,2", new String[] {"x,1,3,1,4,1"}),
        ...
        new ChordDefinition(Bb, CHORD_AUG7, "x,1,4,1,3,x", new String[] {"x,1,4,1,3,x"}),
        ...
        new ChordDefinition(Bb, CHORD_DOM7, "x,1,3,1,3,1", new String[] {"x,1,3,1,4,1"}),
        new ChordDefinition(Bb, CHORD_DOM7, "x,x,3,3,3,4", new String[] {"x,x,1,1,1,2"}),
        ...
        new ChordDefinition(C, CHORD_AUG7, "x,x,2,3,1,4", new String[] {"x,x,2,3,1,4"}),
        ...
        new ChordDefinition(C, CHORD_DOM7, "x,3,2,3,1,0", new String[] {"x,3,2,4,1,x"}),
        new ChordDefinition(C, CHORD_DOM7, "x,3,5,3,5,3", new String[] {"x,1,3,1,4,1"}),
        ...
        new ChordDefinition(C, CHORD_MAJ, "8,10,10,9,8,8"), // (C  E  G) : major triad
        ...
        new ChordDefinition(D, CHORD_AUG7, "x,x,0,3,1,2", new String[] {"x,x,x,3,1,2"}),
        ...
        new ChordDefinition(D, CHORD_DOM7, "x,0,0,2,1,2", new String[] {"x,x,x,2,1,3"}),
        new ChordDefinition(D, CHORD_DOM7, "x,3,x,2,3,2"), // (C  D  Gb A) : major triad, minor 7th
        new ChordDefinition(D, CHORD_DOM7, "x,5,7,5,7,2"), // (C  D  Gb A): major triad, minor 7th
        new ChordDefinition(D, CHORD_DOM7, "x,5,7,5,7,5"), // (C  D  Gb A) : major triad, minor 7th
        new ChordDefinition(D, CHORD_DOM7, "x,x,0,2,1,2", new String[] {"x,x,x,2,1,3"}),
        new ChordDefinition(D, CHORD_DOM7, "x,x,4,5,3,5", new String[] {"x,x,2,3,1,4"}),
        ...
        new ChordDefinition(D, CHORD_MIN, "x,5,7,7,6,5"),
        new ChordDefinition(D, CHORD_MIN, "10,12,12,10,10,10"),
        ...
        new ChordDefinition(Db, CHORD_AUG7, "x,4,3,2,0,1", new String[] {"x,4,3,2,x,1"}),
        new ChordDefinition(Db, CHORD_AUG7, "x,x,3,4,2,5", new String[] {"x,x,2,3,1,4"}),
        ...
        new ChordDefinition(Db, CHORD_DOM7, "x,4,3,4,0,4"), // (Db F  Ab B) : major triad, minor 7th
        new ChordDefinition(Db, CHORD_DOM7, "x,4,3,4,2,x", new String[] {"x,3,2,4,1,x"}),
        new ChordDefinition(Db, CHORD_DOM7, "x,x,3,4,2,4", new String[] {"x,x,2,3,1,4", "x,x,2,3,1,4"}),
        ...
        new ChordDefinition(E, CHORD_AUG7, "x,x,0,1,1,0", new String[] {"x,x,x,1,2,x"}),
        new ChordDefinition(E, CHORD_AUG7, "x,x,2,5,3,4", new String[] {"x,x,1,4,2,3"}),
        ...
        new ChordDefinition(E, CHORD_DOM7, "0,2,0,1,0,0", new String[] {"x,2,x,1,x,x"}),
        new ChordDefinition(E, CHORD_DOM7, "0,2,0,1,3,0", new String[] {"0,2,0,1,4,0"}),
        new ChordDefinition(E, CHORD_DOM7, "0,2,2,1,3,0"), // (D  E  Ab B) : major triad, minor 7th
        new ChordDefinition(E, CHORD_DOM7, "x,2,0,1,3,0"), // (D  E  Ab B) : major triad, minor 7th
        new ChordDefinition(E, CHORD_DOM7, "x,x,0,1,0,0"), // (D  E  Ab B) : major triad, minor 7th
        new ChordDefinition(E, CHORD_DOM7, "x,x,2,4,3,4", new String[] {"x,x,1,3,2,4"}),
        ...
        new ChordDefinition(Eb, CHORD_AUG7, "x,2,1,0,2,3", new String[] {"x,2,1,x,3,4"}),
        ...
        new ChordDefinition(Eb, CHORD_DOM7, "x,1,1,3,2,3"), // (Db Eb G  Bb) : major triad, minor 7th
        new ChordDefinition(Eb, CHORD_DOM7, "x,4,x,3,4,3", new String[] {"x,2,x,1,3,1"}),
        new ChordDefinition(Eb, CHORD_DOM7, "x,6,8,6,8,6"), // (Db Eb G  Bb) : major triad, minor 7th
        new ChordDefinition(Eb, CHORD_DOM7, "x,x,1,3,2,3", new String[] {"x,x,1,3,2,4", "x,x,1,3,2,4"}),
        ...
        new ChordDefinition(F, CHORD_AUG7, "x,x,1,2,2,1", new String[] {"x,x,1,2,3,1"}),
        ...
        new ChordDefinition(F, CHORD_DOM7, "1,3,1,2,1,1", new String[] {"1,3,1,2,1,1", "x,3,1,2,1,1"}),
        new ChordDefinition(F, CHORD_DOM7, "x,x,1,2,1,1"), // (C  Eb F  A) : major triad, minor 7th
        new ChordDefinition(F, CHORD_DOM7, "x,x,3,5,4,5", new String[] {"x,x,1,3,2,4"}),
        ...
        new ChordDefinition(F, CHORD_MAJ, "x,8,10,10,10,8"), // (C  F  A) : major triad
        ...
        new ChordDefinition(G, CHORD_DOM7, "1,x,0,0,0,3"), // (D  F  G  B) : major triad, minor 7th
        new ChordDefinition(G, CHORD_DOM7, "3,2,0,0,0,1", new String[] {"3,2,x,x,x,1", "x,2,x,x,x,1"}),
        new ChordDefinition(G, CHORD_DOM7, "3,5,3,4,3,3", new String[] {"1,3,1,2,1,1"}),
        new ChordDefinition(G, CHORD_DOM7, "x,x,0,0,0,1"), // (D  F  G  B) : major triad, minor 7th
        ...
        new ChordDefinition(Gb, CHORD_AUG7, "x,x,4,3,3,0", new String[] {"x,x,3,1,2,x"}),
        ...
        new ChordDefinition(Gb, CHORD_DOM7, "2,4,2,3,2,2", new String[] {"1,3,1,2,1,1", "x,3,1,2,1,1"}),
        new ChordDefinition(Gb, CHORD_DOM7, "x,x,4,3,2,0", new String[] {"x,x,3,2,1,x"}),
  ...
  public static class ChordDefinition {
    ...
    @Getter
    private List<List<String>> fingers;
    ...
    public ChordDefinition(Note chordRoot, Note addedNote, IntervalPattern chordPattern,
      ...
      this.fingers = (fingers != null ? Arrays.asList(fingers).stream().map(f->Arrays.asList(f.split(","))).collect(Collectors.toList()) : new ArrayList<>());
    }
  }
}
