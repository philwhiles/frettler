...
//      description = "The scale sequence to use")
  ...
  public enum View {
    ARPEGGIO, A(ARPEGGIO), HORIZONTAL, H(HORIZONTAL), VERTICAL, V(VERTICAL), DISPLAY, D(DISPLAY), FIND, F(FIND), CHORD, C(CHORD), BOX, B(BOX), TAB, T(TAB), PROGRESSION, P(PROGRESSION);
    @Getter
    private View type;
